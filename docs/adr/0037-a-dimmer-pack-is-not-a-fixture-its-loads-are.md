...
- **Amended by:** [ADR-0038](0038-bhs-binds-one-way-through-a-local-fixture.md) (2026-09-02) — decision 3 prefix; [#48](https://github.com/jnslmk/beamhouse/issues/48) (2026-09-02) — decision 2 slot table, off by one; [ADR-0045](0045-the-tungsten-curve-is-derived-from-a-declared-lamptype.md) (2026-09-02) — decision 5, where the curve is declared
