...
([ADR-0040](adr/0040-ofl-sole-emitter-draws-the-cone.md)). What OFL has no counterpart for is
...
pixel never does** ([ADR-0040](adr/0040-ofl-sole-emitter-draws-the-cone.md)). The emitter count
